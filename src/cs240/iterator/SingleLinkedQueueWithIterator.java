...
public class SingleLinkedQueueWithIterator<T> implements QueueInterface<T> {
	...
	private class IteratorLinkedQueue implements Iterator<T> {
		private Node<T> nextNode;
		
		private IteratorLinkedQueue() {
			nextNode = front;
		}
